<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/floette.png" width="100"/>
...
=== "Level Up Moves"
	...
	| 25 | Magical-leaf | 60 | - | 20 | ![grass](../img/types/grass.png) | ![special](../img/types/special.png) |
	| 27 | Grassy-terrain | - | - | 10 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 33 | Petal-blizzard | 90 | 100 | 15 | ![grass](../img/types/grass.png) | ![physical](../img/types/physical.png) |
	| 38 | Aromatherapy | - | - | 5 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 43 | Misty-terrain | - | - | 10 | ![fairy](../img/types/fairy.png) | ![status](../img/types/status.png) |
