<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/pyukumuku.png" width="100"/>
...
=== "Level Up Moves"
	...
	| 5 | Helping-hand | - | - | 20 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 17 | Counter | - | 100 | 20 | ![fighting](../img/types/fighting.png) | ![physical](../img/types/physical.png) |
	| 21 | Purify | - | - | 20 | ![poison](../img/types/poison.png) | ![status](../img/types/status.png) |
	| 25 | Curse | - | - | 10 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
	...
	| 37 | Recover | - | - | 5 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 41 | Soak | - | 100 | 20 | ![water](../img/types/water.png) | ![status](../img/types/status.png) |
