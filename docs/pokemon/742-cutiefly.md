<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/cutiefly.png" width="100"/>
...
=== "Level Up Moves"
	...
	| 26 | Bug-buzz | 90 | 100 | 10 | ![bug](../img/types/bug.png) | ![special](../img/types/special.png) |
	| 36 | Aromatherapy | - | - | 5 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 41 | Quiver-dance | - | - | 20 | ![bug](../img/types/bug.png) | ![status](../img/types/status.png) |
