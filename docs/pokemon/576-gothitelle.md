...
=== "Level Up Moves"
	...
	| 34 | Heal-block | - | 100 | 15 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 45 | Telekinesis | - | - | 15 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 54 | Charm | - | 100 | 20 | ![fairy](../img/types/fairy.png) | ![status](../img/types/status.png) |
	| 59 | Magic-room | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
