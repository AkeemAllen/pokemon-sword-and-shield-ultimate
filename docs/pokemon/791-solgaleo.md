<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/solgaleo.png" width="100"/>
  ...
  <div>
    ...
    <div style="display: flex; flex-direction: row; column-gap: 3rem; alignt-items: center; ">
      ...
      <div style="display: flex; flex-direction: row; align-items: center; font-size: 16px">
        <a href='' title='This Pokemon's stats cannot be lowered by other Pokemon's moves or abilities.  This effect only applies to normal stat modifications and not more exotic effects such as topsy turvy or power swap.  This Ability is not bypassed by mold breaker, teravolt, or turboblaze.'>Full-metal-body</a>
...
=== "Level Up Moves"
	...
	| 1 | Sunsteel-strike | 100 | 100 | 5 | ![steel](../img/types/steel.png) | ![physical](../img/types/physical.png) |
	...
	| 1 | Wake-up-slap | 70 | 100 | 10 | ![fighting](../img/types/fighting.png) | ![physical](../img/types/physical.png) |
	| 7 | Iron-head | 80 | 100 | 15 | ![steel](../img/types/steel.png) | ![physical](../img/types/physical.png) |
	| 13 | Metal-sound | - | 85 | 40 | ![steel](../img/types/steel.png) | ![status](../img/types/status.png) |
	| 19 | Zen-headbutt | 80 | 90 | 15 | ![psychic](../img/types/psychic.png) | ![physical](../img/types/physical.png) |
	| 31 | Morning-sun | - | - | 5 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	...
	| 59 | Noble-roar | - | 100 | 30 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 61 | Flare-blitz | 120 | 100 | 15 | ![fire](../img/types/fire.png) | ![physical](../img/types/physical.png) |
	| 67 | Wide-guard | - | - | 10 | ![rock](../img/types/rock.png) | ![status](../img/types/status.png) |
