...
=== "Level Up Moves"
	...
	| 5 | Lucky-chant | - | - | 30 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 7 | Yawn | - | - | 10 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 11 | Psybeam | 65 | 100 | 20 | ![psychic](../img/types/psychic.png) | ![special](../img/types/special.png) |
	| 13 | Imprison | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 17 | Moonlight | - | - | 5 | ![fairy](../img/types/fairy.png) | ![status](../img/types/status.png) |
	| 19 | Hypnosis | - | 60 | 20 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 23 | Zen-headbutt | 80 | 90 | 15 | ![psychic](../img/types/psychic.png) | ![physical](../img/types/physical.png) |
	| 25 | Synchronoise | 120 | 100 | 10 | ![psychic](../img/types/psychic.png) | ![special](../img/types/special.png) |
	| 29 | Nightmare | - | 100 | 15 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
	| 31 | Future-sight | 120 | 100 | 10 | ![psychic](../img/types/psychic.png) | ![special](../img/types/special.png) |
	| 43 | Telekinesis | - | - | 15 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
