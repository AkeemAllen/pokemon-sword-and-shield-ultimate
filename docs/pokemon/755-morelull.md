<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/morelull.png" width="100"/>
...
=== "Level Up Moves"
	...
	| 8 | Flash | - | 100 | 20 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 11 | Moonlight | - | - | 5 | ![fairy](../img/types/fairy.png) | ![status](../img/types/status.png) |
	| 15 | Mega-drain | 40 | 100 | 15 | ![grass](../img/types/grass.png) | ![special](../img/types/special.png) |
	| 18 | Sleep-powder | - | 75 | 15 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 22 | Ingrain | - | - | 20 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 25 | Confuse-ray | - | 100 | 10 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
	| 29 | Giga-drain | 75 | 100 | 10 | ![grass](../img/types/grass.png) | ![special](../img/types/special.png) |
	| 32 | Strength-sap | - | 100 | 10 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 36 | Spore | - | 100 | 15 | ![grass](../img/types/grass.png) | ![status](../img/types/status.png) |
	| 39 | Moonblast | 95 | 100 | 15 | ![fairy](../img/types/fairy.png) | ![special](../img/types/special.png) |
	| 46 | Spotlight | - | - | 15 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
