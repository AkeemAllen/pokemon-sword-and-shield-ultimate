<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/tapu-lele.png" width="100"/>
...
=== "Level Up Moves"
	...
	| 1 | Mean-look | - | - | 5 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 1 | Psychic-terrain | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	...
	| 1 | Draining-kiss | 50 | 100 | 10 | ![fairy](../img/types/fairy.png) | ![special](../img/types/special.png) |
	...
	| 20 | Sweet-scent | - | 100 | 20 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 26 | Skill-swap | - | - | 10 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 38 | Tickle | - | 100 | 20 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 48 | Extrasensory | 80 | 100 | 20 | ![psychic](../img/types/psychic.png) | ![special](../img/types/special.png) |
	| 53 | Flatter | - | 100 | 15 | ![dark](../img/types/dark.png) | ![status](../img/types/status.png) |
	| 58 | Moonblast | 95 | 100 | 15 | ![fairy](../img/types/fairy.png) | ![special](../img/types/special.png) |
