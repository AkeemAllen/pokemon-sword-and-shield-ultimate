<div style="display: flex; flex-direction: row; column-gap: 3rem; align-content: center;">
  <img src="../../img/pokemon/eternatus.png" width="100"/>
...
=== "Level Up Moves"
    | Level | Name | Power | Accuracy | PP | Type | Damage Class |
        | -- | -- | -- | -- | -- | -- | -- |
        	| 1 | Poison-tail | 50 | 100 | 25 | ![poison](../img/types/poison.png) | ![physical](../img/types/physical.png) |
	| 1 | Agility | - | - | 30 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 1 | Dragon-tail | 60 | 90 | 10 | ![dragon](../img/types/dragon.png) | ![physical](../img/types/physical.png) |
	| 1 | Confuse-ray | - | 100 | 10 | ![ghost](../img/types/ghost.png) | ![status](../img/types/status.png) |
	| 8 | Toxic | - | 90 | 10 | ![poison](../img/types/poison.png) | ![status](../img/types/status.png) |
	| 24 | Dragon-dance | - | - | 20 | ![dragon](../img/types/dragon.png) | ![status](../img/types/status.png) |
	...
	| 56 | Dynamax-cannon | 100 | 100 | 5 | ![dragon](../img/types/dragon.png) | ![special](../img/types/special.png) |
	| 64 | Cosmic-power | - | - | 20 | ![psychic](../img/types/psychic.png) | ![status](../img/types/status.png) |
	| 72 | Recover | - | - | 5 | ![normal](../img/types/normal.png) | ![status](../img/types/status.png) |
	| 88 | Eternabeam | 160 | 90 | 5 | ![dragon](../img/types/dragon.png) | ![special](../img/types/special.png) |
